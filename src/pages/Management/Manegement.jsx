    ...
    const handleButtonClick = (type) => {
        ...
        switch (type) {
            ...
            case 'Instagram':
                ...
                setBackgroundColor('radial-gradient(124.65% 124.65% at 37.17% 100.07%, #FD5 0%, #FF543F 32.8%, #FC5245 34.8%, #E64771 50.4%, #D53E91 64.3%, #CC39A4 76.1%, #C837AB 84.1%)');
                break;
                ...
                case 'LinkedIn':
                    ...
                    setBackgroundColor('conic-gradient(from 154deg at 74.69% 49.02%, #2196F3 18.749999552965164deg, #2196F3 155.6249964237213deg, #1E88E5 234.37500715255737deg, #3F51B5 360deg)');
                    break;
        ...
        {/* ... rest of your component ... */}
                    ...
                    <div className='add-section2-wrapper'>
                        <div className='section2-left'>
                            <div className='section2-text'>
                                <h2>Grow With</h2>
                                <h1>{adType}</h1>
                                <p>Google Search campaigns drive results through the Google Search Engine when customers search for a specific keyword that is related to your business, the plus side to these campaigns is that you only have to pay when someone directly clicks on your ad. With continuous optimisation and conversation tracking – Digital Accord strives to deliver the optimal results for your business.</p>
                            </div>
                        </div>
                ...
                <div className='socialmedia-facebook'>
                    <div className='facebook-bottom'>
                        <h2> <span> What is Social </span>Media Management?</h2>
                        <div className="socialmedia-button">
                            <button onClick={() => handleButtonClick('Facebook')} className="facebook-button">
                                <FacebookIcon className="facebook-icon" />
                                <p>Facebook</p>
                            </button>
                            <button onClick={() => handleButtonClick('Instagram')} className="instagram-button">
                                <FaInstagram  />
                                <p>Instagram</p>
                            </button>
                            <button onClick={() => handleButtonClick('LinkedIn')} className="linked-button">
                                <LinkedinIcon />
                                <p>LinkedIn</p>
                            </button>
                            <button onClick={() => handleButtonClick('Google')} className="googlebusiness">
                                <GoogleIcon />
