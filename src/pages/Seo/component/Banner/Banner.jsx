            ...
            <div className='seo-bottom-cloud'>
                ...
                <div className='seo-works-btn-section'>
                    <div className='seo-btn-section'>
                        <h3>How Does</h3>
                        <h1>SEO Work?</h1>
                        <div className='-seo-mobile'>
                            <h1>Competitor<br/> Analysis</h1>
                            <p>
                                Digital Accord provides an in-depth competitor analysis to see where you are ranking and what areas need to be improved on your website and off your website to build your Google relevance.
                            </p>
                        </div>
