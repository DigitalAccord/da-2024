    ...
    const CaseStudy = () => {
        const [selectedRange, setSelectedRange] = useState(["2000", "30000"]);
        ...
        const xValues = chartData1.map(item => item.x);
        ...
        //         console.log(formattedValue,"format value")
        //         return formattedValue;
        //     }
        //     return `$${value}`;
        // };
        
        // const formatSelection = range => {
        //     console.log(range,"formatSelection")
        //     return range.map(value => formatValue(value).slice(0));
                                    ...
                                    <div className='Budget-Range' >
                                            <Histoslider ref={histosliderRef}
                                                data={chartData1.map(item => ({
                                                    x0: item.x0,
                                                    x: item.x.toString(),  // Explicitly convert x to integer
                                                    y: item.y,
                                                }))}
                                                ...
                                                width={450}  // Change this line
                                                height={120}  // Add this line for height
