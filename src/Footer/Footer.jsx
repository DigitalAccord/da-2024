            ...
            <div className='col-md-9'>
              <div className='left-section-wraper'>
                ...
                <div className='form-wrapper '>
                  <form>
                    <div className="mb-3">
                      <label htmlFor="exampleInputEmail1" className="form-label mb-0">Name</label>
                    ...
                    <div className="mb-5">
                      <label htmlFor="exampleInputPassword1" className="form-label" style={{marginBottom:"100px"}}>Message</label>
                      <input type="password" className="form-control" id="exampleInputPassword1" />
                    </div>
...
<circle cx="32" cy="32" r="31.75" fill="white" fillOpacity="0.1" stroke="white" strokeWidth="0.5"/>
<circle cx="104" cy="32" r="31.75" fill="white" fillOpacity="0.1" stroke="white" strokeWidth="0.5"/>
<circle cx="176" cy="32" r="31.75" fill="white" fillOpacity="0.1" stroke="white" strokeWidth="0.5"/>
